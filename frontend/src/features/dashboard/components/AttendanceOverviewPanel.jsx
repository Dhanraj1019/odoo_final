  ...
  return (
    <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-2xs h-full flex flex-col">
      ...
      <div className="grid grid-cols-4 gap-2 mb-4">
        {/* Present */}
        <div className="bg-emerald-50/50 border border-emerald-100/80 rounded-xl p-2.5 text-center">
          <p className="text-[11px] font-bold text-emerald-700">Present</p>
          <p className="text-lg font-black text-slate-900 font-mono mt-0.5">{present}</p>
        </div>

        {/* Late */}
        <div className="bg-amber-50/50 border border-amber-100/80 rounded-xl p-2.5 text-center">
          <p className="text-[11px] font-bold text-amber-700">Late</p>
          <p className="text-lg font-black text-slate-900 font-mono mt-0.5">{late}</p>
        </div>

        {/* Half Day */}
        <div className="bg-blue-50/50 border border-blue-100/80 rounded-xl p-2.5 text-center">
          <p className="text-[11px] font-bold text-blue-700">Half Day</p>
          <p className="text-lg font-black text-slate-900 font-mono mt-0.5">{halfDay}</p>
        </div>

        {/* Absent */}
        <div className="bg-rose-50/50 border border-rose-100/80 rounded-xl p-2.5 text-center">
          <p className="text-[11px] font-bold text-rose-700">Absent</p>
          <p className="text-lg font-black text-slate-900 font-mono mt-0.5">{absent}</p>
        </div>
      </div>
